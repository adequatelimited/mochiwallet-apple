...
HIDE_SIDEBAR_SRC="$PATCHES_DIR/hide-sidebar-button.js"
HIDE_SIDEBAR_DST="$RESOURCES_DIR/hide-sidebar-button.js"
HIDE_MCM_SRC="$PATCHES_DIR/hide-mcm-import.js"
HIDE_MCM_DST="$RESOURCES_DIR/hide-mcm-import.js"
HIDE_EXPORT_SRC="$PATCHES_DIR/hide-export-wallet.js"
HIDE_EXPORT_DST="$RESOURCES_DIR/hide-export-wallet.js"
...
if [ -f "$HIDE_SIDEBAR_SRC" ]; then
    ...
    echo -e "   ${GREEN}✅ hide-sidebar-button.js copied${NC}"
else
...
if [ -f "$HIDE_MCM_SRC" ]; then
    ...
    echo -e "   ${GREEN}✅ hide-mcm-import.js copied${NC}"
else
...
if [ -f "$HIDE_EXPORT_SRC" ]; then
    ...
    echo -e "   ${GREEN}✅ hide-export-wallet.js copied${NC}"
else
...
sed -i.bak '/<script src="\.\/hide-sidebar-button\.js"><\/script>/d' "$TEMP_INDEX"
sed -i.bak '/<script src="\.\/hide-mcm-import\.js"><\/script>/d' "$TEMP_INDEX"
sed -i.bak '/<script src="\.\/hide-export-wallet\.js"><\/script>/d' "$TEMP_INDEX"
