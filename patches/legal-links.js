// iOS-only patch: add legal links (Terms of Service, Privacy Policy) to specific screens
// Only shows on: "Create Wallet" screen (first launch) and "Welcome Back" screen (login)
(function () {
  var CONTAINER_ID = "ios-legal-links";
  ...
  function createLegalLinks() {
    ...
    console.log("[iOS Patch] Added legal links to screen");
  }
