...
[![Build iOS App](https://github.com/adequatesystems/mochiwallet-apple/actions/workflows/build.yml/badge.svg)](https://github.com/adequatesystems/mochiwallet-apple/actions/workflows/build.yml)
...
If you don't have access to a Mac, you have several options:

**📖 See the complete [Windows Development Guide](docs/WINDOWS_DEVELOPMENT.md) for detailed instructions.**

**Quick Options:**

1. **Cloud macOS** (Recommended)
   - [MacStadium](https://www.macstadium.com/) - Rent a Mac in the cloud
   - [MacinCloud](https://www.macincloud.com/) - On-demand macOS access
   - [GitHub Codespaces](https://github.com/features/codespaces) - Cloud development environment

2. **Test Web Extension Locally**
   - The wallet is a web extension that runs in the `mochiwallet/` submodule
   - You can develop and test the extension on Windows in Chrome
   - Only iOS-specific patches require macOS

3. **Use CI/CD**
   - Push changes to GitHub
   - GitHub Actions automatically builds on macOS runners
   - Download build artifacts to verify success
...
│   ├── hide-sidebar-button.js   # Removes panel toggle button
│   ├── hide-mcm-import.js       # Removes MCM file import option
│   ├── hide-export-wallet.js    # Removes backup/export section
...
| `hide-sidebar-button.js` | Removes panel toggle button (browser panel API not available) |
| `hide-mcm-import.js` | Removes "Import MCM File" option (file picker API not available) |
| `hide-export-wallet.js` | Removes Backup section (file download API not available) |
...
- `NSCameraUsageDescription`: Configured for QR code scanning
