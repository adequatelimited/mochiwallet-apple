...
| `patches/hide-sidebar-button.js` | Removes panel toggle button | Optional |
| `patches/hide-mcm-import.js` | Removes MCM file import option | Optional |
| `patches/hide-export-wallet.js` | Removes backup/export section | Optional |
